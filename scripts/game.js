...
function drawSprite(sprite, x, y) {
    ctx.drawImage(spritesheet, sprite*16, 0, 16, 16, x*tileSize + shakeX, y*tileSize + shakeY, tileSize, tileSize);
}
...
function showTitle() {
    ...
    drawText("CELLAR", 40, true, canvas.height/2-110, "yellow");
    drawText("FREAKS", 70, true, canvas.height/2-50, "magenta");
...
function drawScores() {
    let scores = getScores();
    if (scores.length) {
        drawText(rightPad(["RUN", "SCORE", "TOTAL"]), 18, true, canvas.height/2, "white");
